...
class PauseDataset(Dataset):
    ...
    def __getitem__(self, idx: int) -> tuple[Tensor, Tensor]:
        ...
        :return Tuple[Tensor, Tensor]: Cпектрограмма, указание пауз.
        """
    ...
    def _preprocess_data(self, audio: list[Audio], melody: list[Melody]) -> list[tuple[Tensor, Tensor]]:
        """Предобрабатывает аудиофайлы и мелодии.

        :param List[Audio] audio: Аудиофайлы.
        :param List[Melody] melody: Мелодии.
        :return List[Tuple[Tensor, Tensor]]: Спектрограмма, указание пауз.
        """
        preprocessed_data = []
